...
int32_t Memory[1024*5000];// memory
class MIPSSimulator
{
    private: 
        ...
        long NumberOfInstructions; //to store the number of lines in the program
    ...
    public:
        MIPSSimulator(int32_t mode, string fileName, long num_input);
        void Execute();
...
MIPSSimulator::MIPSSimulator(int32_t mode, string fileName, long num_input)
{
...
void MIPSSimulator::Execute()
{
    ...
    {   
        ...
        // if(Mode == 0){
        //     if (count_exec >= 7000000) {
                
        //         PrintRegister(); 
        //         print_register<<"\nPC after　execution:"<<ProgramCounter<<endl;
        //         print_pc<<ProgramCounter<<endl;
        //         print_register<<"************ "<<endl;
        //     }
        // }
        // if (count_exec > 10000000) {
        //     printf ("%ld\n", ProgramCounter);
        // }
        count_exec++;
    }
