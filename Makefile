...
closure.mli closure.ml tuple_flattening.mli tuple_flattening.ml asm.mli asm.ml virtual.mli virtual.ml \
...
min-caml.html: main.mli main.ml id.ml m.ml s.ml debug.mli debug.ml \
		...
		alpha.mli alpha.ml commondelete.mli commondelete.ml beta.mli beta.ml assoc.mli assoc.ml \
		inline.mli inline.ml constFold.mli constFold.ml elim.mli elim.ml \
		closure.mli closure.ml touple_flattening.mli tuple_flattening.ml asm.mli asm.ml virtual.mli virtual.ml \
		simm.mli simm.ml regAlloc.mli regAlloc.ml emit.mli emit.ml
	./to_sparc
